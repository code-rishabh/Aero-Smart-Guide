...
export default function AdminPage() {
  ...
  const stats = [
    { label: 'Total Creators', value: '15' },
    { label: 'Total Guides', value: '156' },
    { label: 'Active Trainees', value: '48' },
    { label: 'Guides This Month', value: '23' }
  ];

  const [recentActivity] = useState([
    { title: 'New Guide Created', desc: 'Maintenance Protocol XJ-238', time: '2 hours ago', color: 'bg-brass' },
    { title: 'New Creator Added', desc: 'Sarah Johnson joined as creator', time: '3 hours ago', color: 'bg-olive' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-brass-light/20">
          <div className="p-8">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-4xl font-bold text-olive">Admin Dashboard</h1>
                <p className="mt-2 text-khaki-dark text-lg">Manage guides, trainees, and creators</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          ...
          <ActionCard
            ...
            icon={BookOpen}
            href="/admin/guides/manage"
          />
          {/* <ActionCard
            title="Guide Allocation"
            description="Assign guides to specific trainees"
            icon={Users}
            href="/admin/guides/allocate"
          /> */}
          <ActionCard
            title="Manage Creators"
            description="Add, edit, or remove creator accounts"
            icon={UserPlus}
            href="/admin/creators"
          />
        </div>
