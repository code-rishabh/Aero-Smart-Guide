...
const sampleTrainees: Trainee[] = [
  {
    ...
    assignedGuides: [
      { id: 'g1', title: 'Vehicle Maintenance Protocol XJ-238', dateAssigned: '2024-03-15' },
      { id: 'g2', title: 'Emergency Response Procedures', dateAssigned: '2024-03-14' },
    ]
  },
  {
    id: '2',
    ...
    assignedGuides: [
      { id: 'g3', title: 'Equipment Safety Guidelines', dateAssigned: '2024-03-13' },
    ]
  },
  // Add more sample trainees as needed
];
